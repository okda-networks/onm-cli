 ...
 */
int cli_help(struct cli_def *cli,struct cli_command *c,  const char *command, char *argv[], int argc);
int cli_history(struct cli_def *cli,struct cli_command *c,  const char *command, char *argv[], int argc);
int cli_exit(struct cli_def *cli,struct cli_command *c,  const char *command, char *argv[], int argc);
int cli_quit(struct cli_def *cli,struct cli_command *c,  const char *command, char *argv[], int argc);
int cli_enable(struct cli_def *cli,struct cli_command *c,  const char *command, char *argv[], int argc);
int cli_disable(struct cli_def *cli,struct cli_command *c,  const char *command, char *argv[], int argc);
