...
yang_core_src = $(ycore_dir)/cmd_list.c $(ycore_dir)/cmd_leaf.c $(ycore_dir)/cmd_container.c
commands_src = src/commands/cmd.c src/commands/yang_cmd_loader.c $(yang_core_src)
